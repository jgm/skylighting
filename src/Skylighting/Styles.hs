...
kate = Style{
      tokenStyles =
        [ ( KeywordTok, defStyle { tokenColor = Just (RGB 31 28 27), tokenBold = Just True })
        ...
        , ( ControlFlowTok, defStyle { tokenColor = Just (RGB 31 28 27), tokenBold = Just True })
        , ( OperatorTok, defStyle { tokenColor = Just (RGB 31 28 27) })
        , ( BuiltInTok, defStyle { tokenColor = Just (RGB 100 74 155), tokenBold = Just True })
        , ( ExtensionTok, defStyle { tokenColor = Just (RGB 0 149 255), tokenBold = Just True })
        ...
        , ( AlertTok, defStyle { tokenColor = Just (RGB 191 3 3), tokenBold = Just True })
        , ( ErrorTok, defStyle { tokenColor = Just (RGB 191 3 3), tokenUnderline = Just True })
...
pygments = Style{
  ...
  , tokenStyles =
    [ (KeywordTok, defStyle{ tokenColor = color 0x007020, tokenBold = Just True })
    ...
    , (CommentTok, defStyle{ tokenColor = color 0x60a0b0, tokenItalic = Just True })
    , (OtherTok, defStyle{ tokenColor = color 0x007020 })
    , (AlertTok, defStyle{ tokenColor = color 0xff0000, tokenBold = Just True })
    , (FunctionTok, defStyle{ tokenColor = color 0x06287e })
    , (ErrorTok, defStyle{ tokenColor = color 0xff0000, tokenBold = Just True })
    , (WarningTok, defStyle{ tokenColor = color 0x60a0b0, tokenItalic = Just True, tokenBold = Just True })
    ...
    , (ControlFlowTok, defStyle{ tokenColor = color 0x007020, tokenBold = Just True })
    ...
    , (DocumentationTok, defStyle{ tokenColor = color 0xBA2121, tokenItalic = Just True })
    , (AnnotationTok, defStyle{ tokenColor = color 0x60a0b0, tokenItalic = Just True, tokenBold = Just True })
    , (CommentVarTok, defStyle{ tokenColor = color 0x60a0b0, tokenItalic = Just True, tokenBold = Just True })
    , (InformationTok, defStyle{ tokenColor = color 0x60a0b0, tokenItalic = Just True, tokenBold = Just True })
    ]
  }
...
tango = Style{
  ...
  , lineNumberBackgroundColor = Nothing
  , tokenStyles =
    [ (KeywordTok, defStyle{ tokenColor = color 0x204a87, tokenBold = Just True })
    ...
    , (CommentTok, defStyle{ tokenColor = color 0x8f5902, tokenItalic = Just True })
    ...
    , (ErrorTok, defStyle{ tokenColor = color 0xa40000, tokenBold = Just True })
    , (WarningTok, defStyle{ tokenColor = color 0x8f5902, tokenItalic = Just True,tokenBold = Just True })
    ...
    , (ControlFlowTok, defStyle{ tokenColor = color 0x204a87, tokenBold = Just True })
    , (OperatorTok, defStyle{ tokenColor = color 0xce5c00, tokenBold = Just True })
    , (PreprocessorTok, defStyle{ tokenColor = color 0x8f5902, tokenItalic = Just True} )
    , (ExtensionTok, defStyle)
    , (AttributeTok, defStyle{ tokenColor = color 0xc4a000 })
    , (DocumentationTok, defStyle{ tokenColor = color 0x8f5902, tokenItalic = Just True, tokenBold = Just True })
    , (AnnotationTok, defStyle{ tokenColor = color 0x8f5902, tokenItalic = Just True,tokenBold = Just True })
    , (CommentVarTok, defStyle{ tokenColor = color 0x8f5902, tokenItalic = Just True,tokenBold = Just True })
    , (InformationTok, defStyle{ tokenColor = color 0x8f5902, tokenItalic = Just True,tokenBold = Just True })
    ]
  }
...
espresso = Style{
  ...
  , tokenStyles =
    [ (KeywordTok, defStyle{ tokenColor = color 0x43A8ED, tokenBold = Just True })
    , (DataTypeTok, defStyle{ tokenUnderline = Just True })
    ...
    , (CommentTok, defStyle{ tokenColor = color 0x0066FF, tokenItalic = Just True })
    , (AlertTok, defStyle{ tokenColor = color 0xffff00 })
    , (FunctionTok, defStyle{ tokenColor = color 0xFF9358, tokenBold = Just True })
    , (ErrorTok, defStyle{ tokenColor = color 0xffff00, tokenBold = Just True })
    , (WarningTok, defStyle{ tokenColor = color 0xffff00, tokenBold = Just True })
    ...
    , (ControlFlowTok, defStyle{ tokenColor = color 0x43A8ED, tokenBold = Just True })
    , (OperatorTok, defStyle)
    , (BuiltInTok, defStyle)
    , (ExtensionTok, defStyle)
    , (PreprocessorTok, defStyle{ tokenBold = Just True })
    , (AttributeTok, defStyle)
    , (DocumentationTok, defStyle{ tokenColor = color 0x0066FF, tokenItalic = Just True })
    , (AnnotationTok, defStyle{ tokenColor = color 0x0066FF, tokenItalic = Just True, tokenBold = Just True })
    , (CommentTok, defStyle{ tokenColor = color 0x0066FF, tokenItalic = Just True, tokenBold = Just True })
    , (InformationTok, defStyle{ tokenColor = color 0x0066FF, tokenItalic = Just True, tokenBold = Just True })
    ]
  }
...
haddock = Style{
  ...
  , tokenStyles =
    ...
    , (ErrorTok, defStyle{ tokenColor = color 0xff0000, tokenBold = Just True })
    , (WarningTok, defStyle{ tokenColor = color 0x008000, tokenBold = Just True })
    , (ConstantTok, defStyle)
...
monochrome = Style{
  ...
  , lineNumberBackgroundColor = Nothing
  , tokenStyles =
    [ (KeywordTok, defStyle{ tokenBold = Just True })
    , (DataTypeTok, defStyle{ tokenUnderline = Just True })
    , (CommentTok, defStyle{ tokenItalic = Just True })
    , (AlertTok, defStyle{ tokenBold = Just True })
    , (ErrorTok, defStyle{ tokenBold = Just True })
    , (WarningTok, defStyle{ tokenItalic = Just True })
    , (ControlFlowTok, defStyle{ tokenBold = Just True })
    , (PreprocessorTok, defStyle{ tokenBold = Just True })
    , (DocumentationTok, defStyle{ tokenItalic = Just True })
    , (AnnotationTok, defStyle{ tokenItalic = Just True })
    , (CommentVarTok, defStyle{ tokenItalic = Just True })
    , (InformationTok, defStyle{ tokenItalic = Just True })
    ]
  }
...
zenburn = Style{
  ...
  , tokenStyles =
    ...
    , (WarningTok, defStyle{ tokenColor = color 0x7f9f7f, tokenBold = Just True })
    , (ConstantTok, defStyle{ tokenColor = color 0xdca3a3, tokenBold = Just True })
    ...
    , (BuiltInTok, defStyle)
    , (ExtensionTok, defStyle)
    , (PreprocessorTok, defStyle{ tokenColor = color 0xffcfaf, tokenBold = Just True })
    , (AttributeTok, defStyle)
    , (DocumentationTok, defStyle{ tokenColor = color 0x7f9f7f })
    , (AnnotationTok, defStyle{ tokenColor = color 0x7f9f7f, tokenBold = Just True })
    , (CommentVarTok, defStyle{ tokenColor = color 0x7f9f7f, tokenBold = Just True })
    , (InformationTok, defStyle{ tokenColor = color 0x7f9f7f, tokenBold = Just True })
    ]
  }
